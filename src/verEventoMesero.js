...
// alert(itemId+" "+prueba);
    ...
    $.ajax({
        type: 'GET',
        url: `https://waiters-browsers-back-end.herokuapp.com/libro/mesero/ver/${itemId}`,
        ...
        function render_items(resp){
          ...
          function addEvento(){
            ...
            $.ajax({
              type: 'GET',
              url: `https://waiters-browsers-back-end.herokuapp.com/prestamo/mesero/${idMesero}`,
          ...
          function render_items(resp){
              ...
              if(status == 1){
                ...
                $.ajax({
                  type: 'PUT',
                  url: `https://waiters-browsers-back-end.herokuapp.com/libro/mesero/${idEvento}`,
                  ...
                  $.ajax({
                    type: 'POST',
                    url: 'https://waiters-browsers-back-end.herokuapp.com/prestamo',
